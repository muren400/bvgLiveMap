...
const stops = new Map([
    ...
    [900003102, { name: "S Bellevue (Berlin)", lat: 52.519951000000, lon: 13.347098000000, id: 900003102, lines: ["S5", "S7", "S7"] }],
    [900003103, { name: "S Tiergarten (Berlin)", lat: 52.513959000000, lon: 13.336241000000, id: 900003103, lines: ["S5", "S7", "S7"] }],
    [900003104, { name: "U Turmstr. (Berlin)", lat: 52.525938000000, lon: 13.341417000000, id: 900003104, lines: ["U9"] }],
    [900003254, { name: "U Bundestag (Berlin)", lat: 52.520110000000, lon: 13.372952000000, id: 900003254, lines: ["U5"] }],
    ...
    [900007104, { name: "S Nordbahnhof (Berlin)", lat: 52.531672000000, lon: 13.388798000000, id: 900007104, lines: ["S1", "S2", "S2"] }],
    [900007110, { name: "U Bernauer Str. (Berlin)", lat: 52.537994000000, lon: 13.396231000000, id: 900007110, lines: ["U8"] }],
    [900008101, { name: "S Humboldthain (Berlin)", lat: 52.544738000000, lon: 13.378730000000, id: 900008101, lines: ["S1", "S2", "S2"] }],
    ...
    [900012101, { name: "S Anhalter Bahnhof (Berlin)", lat: 52.504538000000, lon: 13.382077000000, id: 900012101, lines: ["S1", "S2", "S2"] }],
    ...
    [900020202, { name: "S Beusselstr. (Berlin)", lat: 52.534314000000, lon: 13.328703000000, id: 900020202, lines: ["S4", "S4"] }],
    ...
    [900024101, { name: "S Charlottenburg Bhf (Berlin)", lat: 52.504732000000, lon: 13.303862000000, id: 900024101, lines: ["S5", "S7", "S7"] }],
    [900024102, { name: "S Westkreuz (Berlin)", lat: 52.501152000000, lon: 13.283036000000, id: 900024102, lines: ["S5", "S7", "S7", "S4", "S4"] }],
    [900024106, { name: "S Messe Nord/ZOB (Berlin)", lat: 52.506622000000, lon: 13.282884000000, id: 900024106, lines: ["S4", "S4", "S4"] }],
    ...
    [900024203, { name: "S Savignyplatz (Berlin)", lat: 52.505223000000, lon: 13.319003000000, id: 900024203, lines: ["S5", "S7", "S7"] }],
    ...
    [900026207, { name: "S Westend (Berlin)", lat: 52.518610000000, lon: 13.284237000000, id: 900026207, lines: ["S4", "S4", "S4"] }],
    ...
    [900040101, { name: "S Halensee (Berlin)", lat: 52.496698000000, lon: 13.290151000000, id: 900040101, lines: ["S4", "S4", "S4"] }],
    ...
    [900044101, { name: "S Hohenzollerndamm (Berlin)", lat: 52.488337000000, lon: 13.300714000000, id: 900044101, lines: ["S4", "S4", "S4"] }],
    ...
    [900054104, { name: "S Schöneberg (Berlin)", lat: 52.479811000000, lon: 13.352848000000, id: 900054104, lines: ["S1", "S4", "S4", "S4", "S4"] }],
    ...
    [900058101, { name: "S Südkreuz Bhf (Berlin)", lat: 52.475502000000, lon: 13.365552000000, id: 900058101, lines: ["S2", "S2", "S4", "S4", "S4", "S4"] }],
    [900058102, { name: "S Priesterweg (Berlin)", lat: 52.459239000000, lon: 13.356028000000, id: 900058102, lines: ["S2", "S2"] }],
    ...
    [900063452, { name: "S Südende (Berlin)", lat: 52.448899000000, lon: 13.354077000000, id: 900063452, lines: ["S2"] }],
    [900064201, { name: "S Lichterfelde Süd (Berlin)", lat: 52.409956000000, lon: 13.308662000000, id: 900064201, lines: ["S2"] }],
    [900064256, { name: "S Osdorfer Str. (Berlin)", lat: 52.418373000000, lon: 13.313865000000, id: 900064256, lines: ["S2"] }],
    [900064301, { name: "S Lichterfelde Ost Bhf (Berlin)", lat: 52.429294000000, lon: 13.327749000000, id: 900064301, lines: ["S2"] }],
    ...
    [900067221, { name: "S Lankwitz (Berlin)", lat: 52.439034000000, lon: 13.342760000000, id: 900067221, lines: ["S2"] }],
    ...
    [900077106, { name: "S Sonnenallee (Berlin)", lat: 52.473843000000, lon: 13.455986000000, id: 900077106, lines: ["S4", "S4"] }],
    [900077155, { name: "S Köllnische Heide (Berlin)", lat: 52.469168000000, lon: 13.467529000000, id: 900077155, lines: ["S4", "S4"] }],
    ...
    [900084101, { name: "S Wilhelmsruh (Berlin)", lat: 52.581389000000, lon: 13.362938000000, id: 900084101, lines: ["S1", "S8"] }],
    [900085104, { name: "U Paracelsus-Bad (Berlin)", lat: 52.574432000000, lon: 13.347301000000, id: 900085104, lines: ["U8"] }],
    [900085105, { name: "S Alt-Reinickendorf (Berlin)", lat: 52.577969000000, lon: 13.349747000000, id: 900085105, lines: ["S2"] }],
    [900085201, { name: "S Schönholz (Berlin)", lat: 52.571901000000, lon: 13.380242000000, id: 900085201, lines: ["S1", "S2", "S8"] }],
    ...
    [900091203, { name: "S Heiligensee (Berlin)", lat: 52.625148000000, lon: 13.228667000000, id: 900091203, lines: ["S2"] }],
    [900091205, { name: "S Schulzendorf (Berlin)", lat: 52.613513000000, lon: 13.245630000000, id: 900091205, lines: ["S2"] }],
    ...
    [900094101, { name: "S Waidmannslust (Berlin)", lat: 52.606814000000, lon: 13.320549000000, id: 900094101, lines: ["S1", "S8"] }],
    [900096405, { name: "S Eichborndamm (Berlin)", lat: 52.577545000000, lon: 13.315583000000, id: 900096405, lines: ["S2"] }],
    [900096410, { name: "U Rathaus Reinickendorf (Berlin)", lat: 52.588218000000, lon: 13.325568000000, id: 900096410, lines: ["U8"] }],
    [900100002, { name: "S Hackescher Markt (Berlin)", lat: 52.522607000000, lon: 13.402358000000, id: 900100002, lines: ["S5", "S7", "S7"] }],
    [900100007, { name: "S Oranienburger Str. (Berlin)", lat: 52.525161000000, lon: 13.393068000000, id: 900100007, lines: ["S1", "S2", "S2"] }],
    ...
    [900110002, { name: "S Prenzlauer Allee (Berlin)", lat: 52.544802000000, lon: 13.427419000000, id: 900110002, lines: ["S8", "S8", "S9", "S4", "S4"] }],
    [900110003, { name: "S Greifswalder Str. (Berlin)", lat: 52.540724000000, lon: 13.438356000000, id: 900110003, lines: ["S8", "S8", "S9", "S4", "S4"] }],
    [900110004, { name: "S Landsberger Allee (Berlin)", lat: 52.528772000000, lon: 13.455944000000, id: 900110004, lines: ["S8", "S8", "S9", "S4", "S4"] }],
    ...
    [900110011, { name: "S Bornholmer Str. (Berlin)", lat: 52.554763000000, lon: 13.397841000000, id: 900110011, lines: ["S1", "S2", "S2", "S8", "S8", "S9"] }],
    [900110012, { name: "S Storkower Str. (Berlin)", lat: 52.523868000000, lon: 13.464704000000, id: 900110012, lines: ["S8", "S8", "S9", "S4", "S4"] }],
    [900120003, { name: "S Ostkreuz Bhf (Berlin)", lat: 52.503113000000, lon: 13.469221000000, id: 900120003, lines: ["S3", "S5", "S7", "S7", "S8", "S8", "S9", "S4", "S4"] }],
    [900120005, { name: "S Ostbahnhof (Berlin)", lat: 52.510331000000, lon: 13.435086000000, id: 900120005, lines: ["S5", "S7", "S7"] }],
    ...
    [900130003, { name: "S Wollankstr. (Berlin)", lat: 52.564974000000, lon: 13.393150000000, id: 900130003, lines: ["S1", "S2", "S8"] }],
    ...
    [900160003, { name: "S Nöldnerplatz (Berlin)", lat: 52.503444000000, lon: 13.484297000000, id: 900160003, lines: ["S5", "S7", "S7"] }],
    ...
    [900171002, { name: "S Friedrichsfelde Ost (Berlin)", lat: 52.513531000000, lon: 13.519078000000, id: 900171002, lines: ["S5", "S7", "S7"] }],
    ...
    [900186001, { name: "S Grünau (Berlin)", lat: 52.412714000000, lon: 13.574018000000, id: 900186001, lines: ["S8", "S8", "S4"] }],
    [900190001, { name: "S Treptower Park (Berlin)", lat: 52.493832000000, lon: 13.461825000000, id: 900190001, lines: ["S8", "S8", "S9", "S4", "S4"] }],
    [900191001, { name: "S Baumschulenweg (Berlin)", lat: 52.467581000000, lon: 13.489505000000, id: 900191001, lines: ["S8", "S8", "S9", "S4", "S4", "S4"] }],
    [900191002, { name: "S Plänterwald (Berlin)", lat: 52.478722000000, lon: 13.474029000000, id: 900191002, lines: ["S8", "S8", "S9"] }],
    [900192001, { name: "S Schöneweide Bhf (Berlin)", lat: 52.454611000000, lon: 13.510149000000, id: 900192001, lines: ["S8", "S8", "S9", "S4", "S4", "S4"] }],
    [900192002, { name: "S Oberspree (Berlin)", lat: 52.452269000000, lon: 13.538461000000, id: 900192002, lines: ["S4"] }],
    [900193001, { name: "S Johannisthal (Berlin)", lat: 52.446695000000, lon: 13.524028000000, id: 900193001, lines: ["S8", "S8", "S9", "S4", "S4", "S4"] }],
    [900193002, { name: "S Adlershof (Berlin)", lat: 52.435102000000, lon: 13.540553000000, id: 900193002, lines: ["S8", "S8", "S9", "S4", "S4", "S4"] }],
    [900194006, { name: "S Schöneweide/Sterndamm (Berlin)", lat: 52.452621000000, lon: 13.508668000000, id: 900194006, lines: [] }],
    [900195510, { name: "S Altglienicke (Berlin)", lat: 52.407791000000, lon: 13.559602000000, id: 900195510, lines: ["S9", "S4"] }],
    [900196001, { name: "S Grünbergallee (Berlin)", lat: 52.399539000000, lon: 13.543222000000, id: 900196001, lines: ["S9", "S4"] }],
    [900200000, { name: "S Hennigsdorf Bhf", lat: 52.637867000000, lon: 13.205874000000, id: 900200000, lines: ["S2"] }],
    ...
    [900260001, { name: "S Königs Wusterhausen Bhf", lat: 52.296963000000, lon: 13.631305000000, id: 900260001, lines: ["S4"] }],
    [900260002, { name: "S Wildau", lat: 52.319205000000, lon: 13.633587000000, id: 900260002, lines: ["S4"] }],
    [900260003, { name: "S Zeuthen", lat: 52.349351000000, lon: 13.627012000000, id: 900260003, lines: ["S8", "S4"] }],
    [900260004, { name: "S Eichwalde", lat: 52.371909000000, lon: 13.615038000000, id: 900260004, lines: ["S8", "S4"] }],
    [900260005, { name: "S Schönefeld (bei Berlin) Bhf", lat: 52.390906000000, lon: 13.513046000000, id: 900260005, lines: ["S9", "S4"] }],
